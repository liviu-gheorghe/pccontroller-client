...
public class DispatchedActionsCodes {
    public static int ACTION_SEND_DEVICE_NAME = 0;
    ...
    public static int ACTION_SEND_CONNECTION_REQUEST = 4;
    public static int ACTION_SEND_DEVICE_BATTERY_LEVEL = 5;
    public static int ACTION_SEND_DEVICE_OS_LEVEL = 6;
